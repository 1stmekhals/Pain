      ...
      {!isDayTime ? (
        ...
        Array.from({ length: 3 }).map((segment) => (
          <motion.div 
            ...
            className="absolute w-24 h-24"
            style={{ 
              // Same positioning as moon but for sun
              transform: `translateX(${(normalizedOffset * 0.3) + (segment * SKY_CIRCUMFERENCE * 0.3)}px)`,
              right: '10%',
              top: '10%',
              left: `${segment * 100 + 80}%`,
          ...
          <div className="relative w-full h-full">
            ...
            <div
              className="w-full h-full rounded-full"
              style={{
                // Complex gradient system for realistic solar surface
                background: `
                ...
                `,
                // Multiple glow effects for sun appearance
                boxShadow: `
              ...
              <div className="absolute inset-0 rounded-full overflow-hidden">
                ...
                <div
                  ...
                  style={{
                    ...
                    left: '20%',
                    top: '10%',
                    // Orange gradient for solar prominence
                ...
                {/* Sunspots (dark areas on solar surface) */}
                {/* Sunspots */}
                <div
                  className="absolute opacity-30"
                  style={{
                    ...
                    left: '45%',
                    top: '40%',
                    // Dark brown gradient for sunspot
                ...
                <div
                  ...
                  style={{
                    ...
                    left: '30%',
                    top: '50%',
                    // Bright white gradient for active solar regions
